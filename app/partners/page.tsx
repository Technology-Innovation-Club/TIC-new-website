    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <p className="mt-5 text-lg text-foreground/70 leading-relaxed max-w-3xl">
          We work with leading companies and organizations to create opportunities
          for our members and drive innovation in Africa's tech ecosystem.
        </p>
        <div className="mt-10 rounded-2xl border border-border bg-gray-50 p-8">
          <p className="font-semibold text-primary font-poppins">Partnership Benefits</p>
